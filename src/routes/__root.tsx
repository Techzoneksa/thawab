...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "نظام خاص لإدارة الجمعيات والجهات الخيرية في المملكة العربية السعودية." },
      { name: "author", content: "Techzone" },
      { property: "og:title", content: "ثواب — نظام إدارة الجمعيات والجهات الخيرية" },
      { property: "og:description", content: "نظام خاص لإدارة الجمعيات والجهات الخيرية في المملكة العربية السعودية." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "ثواب — نظام إدارة الجمعيات والجهات الخيرية" },
      { name: "twitter:description", content: "نظام خاص لإدارة الجمعيات والجهات الخيرية في المملكة العربية السعودية." },
