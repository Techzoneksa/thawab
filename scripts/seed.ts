...
const COA: Row[] = [
  ...
  ["120107", "أصول ثابتة — حساب رقابة", "asset", true, "fixed_assets"],
  ...
  ["120206", "مجمع الإهلاك — حساب رقابة", "asset", true, "accumulated_depreciation"],
  ...
  ["4403", "أرباح بيع أصول ثابتة", "revenue", true, "asset_disposal_gain"],
  ...
  ["5201", "الرواتب والأجور", "expense", true, "salaries_expense"],
  ...
  ["5312", "مصروف الإهلاك", "expense", true, "depreciation_expense"],
  ["5313", "مصروفات الحوكمة (المجلس/الاجتماعات)", "expense", true],
  ["5314", "رسوم واشتراكات حكومية", "expense", true],
  ["5315", "مصروفات متنوعة", "expense", true, "asset_disposal_loss"],
